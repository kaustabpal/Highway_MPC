...
class Agent:
    def __init__(self, agent_id, i_state, g_state, vg, wg, p_horizon, u_horizon):
        ...
        self.agent_radius = 0.8
        self.obst_radius = 0.8
...
#        input("Press enter to continue:")
        ...
        ## constant part
        s_r = (self.agent_radius + self.obst_radius)**2 + 1.5
