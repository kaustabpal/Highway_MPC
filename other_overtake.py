...
def main():
    ...
    agent3 = Agent(3, [0,0,np.deg2rad(90)],[0,50,np.deg2rad(85)], vg, wg, p_horizon, u_horizon)
    # agent2 = Agent(2, [-5,0,np.deg2rad(90)],[-5,50,np.deg2rad(85)], vg, wg, p_horizon, u_horizon)
    agent1 = Agent(1, [0,agent3.c_state[1]+5,np.deg2rad(90)],[0,45,np.deg2rad(85)], vg, wg, p_horizon, u_horizon)
    ...
    #         dist1.append(get_dist(agent1.c_state, agent2.c_state))
        ...
        # agent2.g_state[1] = agent2.c_state[1] + 30    
        # agent2.vl = agent2.v
        # agent2.wl = agent2.w
